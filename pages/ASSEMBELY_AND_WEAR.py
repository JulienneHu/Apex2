...
st.image('assests/Apex2/Step1.jpg', caption='Step 1', width=400)
st.subheader("Step 2: Rotate clockwise to lock the clutch on the back support")
st.image('assests/Apex2/Step2.jpg', caption='Step 2', width=400)
st.subheader("Step 3: Back view of the assembled part")
st.image('assests/Apex2/Step3.jpg', caption='Step 3', width=400)
st.subheader("Step 4: Slide the bands to the clutch")
st.image('assests/Apex2/Step4.jpg', caption='Step 4', width=400)
st.subheader("Step 5:Set all the bands to the clutch")
st.image('assests/Apex2/Step5.jpg', caption='Step 5', width=400)   
st.subheader("Step 6: Set all the thigh sleeves to the bands conencted to the clutch")
st.image('assests/Apex2/Step6.jpg', caption='Step 6', width=400)
st.subheader("Step 7: Final look of the assembled Apex2")
st.image('assests/Apex2/Step7.jpg', caption='Step 7', width=400)



st.subheader("Reference Videos")
video = open("assests/Apex2/Apex2.mov", "rb")
